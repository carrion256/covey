...
pub use model::{
    ...
    MetaTaskStatus, ModelId, ObjectType, ObserveVcsWorkspaceReq, OpenSpecArchiveBlockedReason,
    ...
    TimestampMs, TypedEvent, VcsPacketStackEntry, VcsPacketStackEntryId, VcsPacketStackEntryState,
    VcsPrPublication, VcsPrPublicationId, VcsPrPublicationKind, VcsPrPublicationStatus,
    VcsWorkspace, VcsWorkspaceCleanliness, VcsWorkspaceId, VcsWorkspaceKind,
