CREATE TABLE IF NOT EXISTS openspec_archive_status_new (
...
INSERT INTO openspec_archive_status_new (
    queue_id, subtask_id, artifact_digest, openspec_change_id, state,
    blocked_reason, archive_proof_digest, recorded_by_session, created_at, updated_at
)
SELECT
    queue_id, subtask_id, artifact_digest, openspec_change_id, state,
    blocked_reason, archive_proof_digest, recorded_by_session, created_at, updated_at
...
DROP TABLE openspec_archive_status;

ALTER TABLE openspec_archive_status_new RENAME TO openspec_archive_status;
